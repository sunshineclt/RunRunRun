...
def get_observation(self):
    ...
    body_transforms = [
        [self.osim_model.get_body(body).getTransformInGround(self.osim_model.state).p()[i] for i in range(2)] for body
        in bodies]
...
def generate_observation(new, old=None, step=None):
    ...
    # process new
    def lp(n):
        return list(process_observation(n))
    ...
    def addball_if_new():
        ball_ahead  # previously nonlocal in python3
